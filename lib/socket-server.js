    ...
    socket.on("chat-message", async (data) => {
      try {
        ...
        try {
          ...
          // Emit global event to notify all connected clients about new message
          // This allows clients to refresh rooms list when any message arrives
          console.log("🔄 Emitting global-message-received for room:", roomId)
          io.emit("global-message-received", {
            roomId,
          ...
          // Emit global event even when database is not available
          console.log("🔄 Emitting global-message-received for room (local):", roomId)
          io.emit("global-message-received", {
            roomId,
